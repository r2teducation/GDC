...
class _CreateTreatmentWidgetState extends State<CreateTreatmentWidget> {
  ...
  final TextEditingController _dentalComplicationsCtrl = TextEditingController();

  // --------- Doctor Notes & Consent ---------
  final TextEditingController _doctorNotesCtrl = TextEditingController();
  bool _patientConsent = false;
  final TextEditingController _patientSignatureCtrl = TextEditingController(); // placeholder for signature name
  ...
  Future<void> _onSave() async {
    ...
    if (!_patientConsent) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Patient consent is required to save the record')),
      );
      return;
    }
          ...
          child: Container(
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  const Text('Create Treatment', style: TextStyle(fontSize: 28, fontWeight: FontWeight.w800)),
                        ...
                        child: Column(
                          ...
                          children: [
                            const Padding(
                              ...
                              child: Text("Patient Search", style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: Color(0xFF111827))),
                            ),
                            if (_loadingPatients)
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Slider(
                              ...
                              onChanged: (v) => setState(() => _breathingRate = v),
                            ),
                          ],
                        ),
                      ),
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            TextFormField(
                              ...
                              inputFormatters: [FilteringTextInputFormatter.allow(RegExp(r'^\d+\.?\d{0,2}')), LengthLimitingTextInputFormatter(6)],
                    ...
                    children: [
                      Expanded(
                        child: CheckboxListTile(
                          ...
                          value: _drugAllergy,
                          onChanged: (v) => setState(() => _drugAllergy = v ?? false),
                        ),
                      ),
                      Expanded(
                        child: CheckboxListTile(
                          ...
                          value: _foodAllergy,
                          onChanged: (v) => setState(() => _foodAllergy = v ?? false),
                        ),
                      ),
                      Expanded(
                        child: CheckboxListTile(
                          ...
                          value: _latexAllergy,
                          onChanged: (v) => setState(() => _latexAllergy = v ?? false),
                        ),
                      ),
                    ],
                  ),
                                ...
                                Expanded(
                                  ...
                                  child: TextFormField(
                                    ...
                                    validator: (v) {
                                      ...
                                      if (any && (v == null || v.trim().isEmpty)) return 'Required';
                                      return null;
                                    },
                                  ),
                                ),
                    ...
                    children: _dental.keys.map((k) {
                      return SizedBox(
                        ...
                        child: CheckboxListTile(
                          ...
                          title: Text(k),
                          value: _dental[k],
                          onChanged: (v) => setState(() => _dental[k] = v ?? false),
                        ),
                      );
                    }).toList(),
                  ),
                  ...
                  TextFormField(
                    ...
                    decoration: _dec('Dental complications / history (describe)'),
                    minLines: 1,
                    maxLines: 4,
                  ),
                  ...
                  CheckboxListTile(
                    ...
                    onChanged: (v) => setState(() => _patientConsent = v ?? false),
                  ),
                  const SizedBox(height: 8),
                  Row(
                    children: [
                      Expanded(
                        child: TextFormField(
                          ...
                          decoration: _dec('Patient signature / name (or scanned image ref)'),
                          validator: (v) {
                            if (_patientConsent && (v == null || v.trim().isEmpty)) {
                      ...
                      SizedBox(
                        ...
                        child: OutlinedButton(
                          onPressed: () {
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(content: Text('Signature capture not implemented here')));
                          },
                          style: OutlinedButton.styleFrom(
                            padding: const EdgeInsets.symmetric(vertical: 16, horizontal: 12),
                            shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8)),
                          ...
                          child: Row(
                            ...
                            children: const [Icon(Icons.edit, size: 18), SizedBox(width: 8), Text('Capture')],
                          ),
                        ),
                      ),
                    ],
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        ...
                        child: _saving
                            ...
                            : const Text('Save Treatment', style: TextStyle(fontWeight: FontWeight.w700)),
                      ),
                    ],
                  ),
                ],
