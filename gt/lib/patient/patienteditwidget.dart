...
class PatientEditWidget extends StatefulWidget {
  ...
  const PatientEditWidget({
    super.key,
    required this.patientId,
  });

  @override
  State<PatientEditWidget> createState() => _PatientEditWidgetState();
}
...
class _PatientEditWidgetState extends State<PatientEditWidget> {
  ...
  Future<void> _loadPatient() async {
    final doc = await _db.collection('patients').doc(widget.patientId).get();
  ...
  Future<void> _onUpdate() async {
    ...
    if (_gender == null || _referredBy == null) {
      ScaffoldMessenger.of(context).showSnackBar(
